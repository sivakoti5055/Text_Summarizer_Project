...
from text_summarize.pipeline.Stage_05_model_evaluation_pipeline import ModelEvalutaionPipeline
...
STAGED_NAME = "Model Evaluation Stage"
try:
    logger.info("stage {STAGED_NAME} is started")
    model_training = ModelEvalutaionPipeline()
    model_training.main()
    logger.info("stage {STAGED_NAME} is completed")
except Exception as e:
    logger.exception(e)
